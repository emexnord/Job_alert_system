...
def create_app():
    app = Flask(__name__)
    app.config['SQLALCHEMY_DATABASE_URI'] = environ.get('DB_URL','postgresql://postgres:postgres@localhost:5432/jobs_db')
    ...
    def create_company():
        try:
            ...
            company = company_service.create_company(data['name'], data['scraping_url'])
